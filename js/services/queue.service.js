(function () {
    ...
    angular.module('ceremoniesApp').factory('Queue', function (FrameService) {
        ...
        // catalog: $scope.catalog — {skillNumber: [slide,...], '__albertVidal__': [...]}
        // albertVidalFrame: id of the frame currently showing the Albert Vidal Award, or ''
        function getSkillQueueSlides(catalog, albertVidalFrame, skillNumber) {
            ...
            if (skillNumber === '__albertVidal__') {
                ...
                if (!avaFrameId || !catalog['__albertVidal__']) return [];
        ...
        // Flat, ceremony-ordered queue across every frame: each catalog skill
        // (in skills order) followed by the Albert Vidal Award last.
        function buildQueueList(catalog, skills, albertVidalFrame) {
            ...
            if (albertVidalFrame && catalog['__albertVidal__']) {
