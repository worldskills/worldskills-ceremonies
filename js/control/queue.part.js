(function () {
    ...
    // The cross-frame slide queue: the flat ceremony-order list, the skills
    // navigator, and skill→frame (re)assignment. See the two invariants
    // above the *Part(scope) calls in js/control.js.
    angular.module('ceremoniesApp').factory('QueuePart', function (FrameService, Queue, QueueScroll) {
