...
const symbols = {
    ...
    Prod:
        '<rect x="26" y="24" width="92" height="58" rx="5"/>' +
        '<path d="M52 95h40M72 82v13"/>' +
        '<path d="m62 39 26 15-26 15z" fill="white" stroke="none"/>',
    Frames:
        '<rect x="18" y="31" width="30" height="44" rx="4" stroke="#D51067"/>' +
    ...
    Grid:
        '<rect x="22" y="20" width="100" height="62" rx="5"/>' +
...
function profileIcon(name, color) {
    ...
    return (
        ...
        '<rect width="144" height="144" rx="16" fill="' +
        background +
        '"/>' +
        '<g fill="none" stroke="' +
        stroke +
