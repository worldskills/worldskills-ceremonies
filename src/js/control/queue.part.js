(function () {
    ...
    // Shares ControlCtrl's scope — see the two invariants above the
    // *Part(scope) calls in js/control.js.
    angular.module('ceremoniesApp').factory('QueuePart', function (FrameService, Queue, QueueScroll, SLIDE_KEYS) {
